...
enum Types   { OBJ_BASE, OBJ_PLAYER, OBJ_ENEMY, OBJ_TERRA, OBJ_SPELL, OBJ_EVENT, OBJ_RETICLE, OBJ_ENERGY, OBJ_T3SPELL, OBJ_FLOCK };  // All Tiles need to have "at least" the OBJ_TERRA type.
