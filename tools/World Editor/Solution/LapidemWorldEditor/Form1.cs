...
namespace LapidemWorldEditor
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            TmTileSet = ManagedTextureManager.Instance.LoadTexture("..\\..\\resource\\graphics\\ScA_WorldTileset.PNG", Color.FromArgb(255, 0, 255).ToArgb());
            tileSet = new Bitmap("..\\..\\resource\\graphics\\ScA_WorldTileset.PNG");
        ...
        {
           toolStripStatusLabel1.Text = "Note: Click and drag with the Right Click to scroll the World Map";
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == save.ShowDialog())
            {
                ...
                bWriter.Write(CollumnTile);
                bWriter.Write(RowTile);
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == open.ShowDialog())
            {
                ...
                if (version != "lapidem V4")
                    if (version == "lapidem" || version == "lapidem V2")
                ...
                if (version != "lapidem" && version != "lapidem V2")
                {
                    CollumnTile = reader.ReadInt32();
                    RowTile = reader.ReadInt32();
                }
                ...
                if (BgFilename  != " ")
                {
                    BgImgID = ManagedTextureManager.Instance.LoadTexture(path+BgFilename, 0);
                    label16.Text = BgFilename;
                }

                if (filePath != " ")
                {
                    tileSet = new Bitmap(path + filePath);
                    ManagedTextureManager.Instance.ReleaseTexture(TmTileSet);
                    TmTileSet = ManagedTextureManager.Instance.LoadTexture(path + filePath , 0);
                }
        ...
        private void newToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            label16.Text= BgFilename = " ";
            filePath = " ";
            label17.Text=NextLvlFilename = " ";
            label18.Text= bgMfilenamel = " ";
            toolStripStatusLabel1.Text = " ";
        }
    }
}
